...
<html lang="en"><head>
	...
	<title>xenixstudio 서비스 플랫폼 - 서비스 디바이스 수정</title>
	...
	<script>
		$(document).ready(function() {
			...
			var m_current_device = '<?php echo $service_device['device']; ?>';
			if(m_current_device == 'ANDROID')
			{
			...
			$('#write_btn').click(function(){
				...
				var m_service_device_id = $('#service_device_id').val();
				...
				if(m_device == 'ANDROID')
				{
					...
					{	
						$.ajax({ 
							type: 'POST',
							url: "/service_device/modify",
							dataType: "json",
							data: 'service_device_id='+m_service_device_id+'&service_id='+m_service_id+'&device='+m_device+'&version_name='+m_version_name+'&version_code='+m_version_code+'&gcm_service_key='+m_gcm_service_key+'&gcm_package_name='+m_package_name+'&gcm_queue_name='+m_queue_name+'&gcm_worker_count='+m_worker_count+'&gcm_feedback_api1='+m_feedback_api1+'&gcm_feedback_api2='+m_feedback_api2,
							error:function(data){
				...
				else // IPHONE
				{
					...
					{	
						$.ajax({ 
							...
							url: "/service_device/modify",
							dataType: "json",
							data: 'service_device_id='+m_service_device_id+'&service_id='+m_service_id+'&device='+m_device+'&version_name='+m_version_name+'&version_code='+m_version_code+'&cert='+m_cert+'&key='+m_key+'&is_production='+m_is_production+'&apns_queue_name='+m_queue_name+'&apns_worker_count='+m_worker_count+'&apns_feedback_api1='+m_feedback_api1+'&apns_feedback_api2='+m_feedback_api2,
							error:function(data){
								alert('등록 실패했습니다.\nstatusCode : ' + data.readyState + '\nresponseText : ' + data.responseText);
								console.log(data.responseText);
							},
...
<div class="page-container" style="min-height:100%;"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->	
	...
	<div class="main-content" style="min-height: 100%;">
		...
		<h2><?php echo $service_device['name']; ?> 디바이스 수정</h2>
		<br/>
				...
				<div class="panel panel-primary" data-collapsed="0">
					...
					<div class="panel-body">
						...
						<form role="form" class="form-horizontal form-groups-bordered" enctype="multipart/form-data">
							...
							<input type="hidden" id="service_device_id" value="<?php echo $service_device['service_device_id']; ?>" />
							<input type="hidden" id="service_id" value="<?php echo $service_device['service_id']; ?>" />
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<select class="form-control" id="service">
										<option value="<?php echo $service_device['service_id']; ?>"><?php echo $service_device['name']; ?></option>	
									</select>
								</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-2">
									<select class="form-control" id="device">
										<option value="<?php echo $service_device['device']; ?>"><?php echo $service_device['device']; ?></option>
									</select>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" class="form-control" id="version_name" value="<?php echo $service_device['version_name']; ?>">
								</div>								
							</div>														
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" class="form-control" id="version_code" value="<?php echo $service_device['version_code']; ?>">
								</div>								
							</div>
							...
							<div class="form-group android">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="gcm_service_key" value="<?php echo $service_device['gcm_service_key']; ?>">
								</div>								
							</div>
							...
							<div class="form-group android">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="gcm_package_name" value="<?php echo $service_device['gcm_package_name']; ?>">
								</div>								
							</div>
							...
							<div class="form-group android">
								...
								<div class="col-sm-1">
									<input type="text" class="form-control" id="gcm_worker_count" value="<?php echo $service_device['gcm_worker_count']; ?>">
								</div>								
							</div>
							...
							<div class="form-group android">
								...
								<div class="col-sm-3">
									<input type="text" class="form-control" id="gcm_queue_name" value="<?php echo $service_device['gcm_queue_name']; ?>">
								</div>								
							</div>
							...
							<div class="form-group android">
								...
								<div class="col-sm-7">
									<input type="text" class="form-control" id="gcm_feedback_api1" value="<?php echo $service_device['gcm_feedback_api1']; ?>">
								</div>								
							</div>
							...
							<div class="form-group android">
								...
								<div class="col-sm-7">
									<input type="text" class="form-control" id="gcm_feedback_api2" value="<?php echo $service_device['gcm_feedback_api2']; ?>">
								</div>								
							</div>
							...
							<div class="form-group iphone" style="display:none;">
								...
								<div class="col-sm-7">
									<textarea class="form-control" rows="5" id="cert"><?php echo $service_device['cert']; ?></textarea>
								</div>								
							</div>
							...
							<div class="form-group iphone" style="display:none;">
								...
								<div class="col-sm-7">
									<textarea class="form-control" rows="5" id="key"><?php echo $service_device['key']; ?></textarea>
								</div>								
							</div>
							...
							<div class="form-group iphone" style="display:none;">
								...
								<div class="col-sm-3">
									<select class="form-control" id="is_production">
										<option value="1" <?php if($service_device['is_production'] == 1){echo 'selected="true"';} ?> >Production</option>	
										<option value="0" <?php if($service_device['is_production'] == 0){echo 'selected="true"';} ?> >Development</option>	
									</select>
								</div>								
							</div>
							...
							<div class="form-group iphone" style="display:none;">
								...
								<div class="col-sm-1">
									<input type="text" class="form-control" id="apns_worker_count" value="<?php echo $service_device['apns_worker_count']; ?>">
								</div>								
							</div>
							...
							<div class="form-group iphone" style="display:none;">
								...
								<div class="col-sm-3">
									<input type="text" class="form-control" id="apns_queue_name" value="<?php echo $service_device['apns_queue_name']; ?>">
								</div>								
							</div>
							...
							<div class="form-group iphone" style="display:none;">
								...
								<div class="col-sm-7">
									<input type="text" class="form-control" id="apns_feedback_api1" value="<?php echo $service_device['apns_feedback_api1']; ?>">
								</div>								
							</div>
							...
							<div class="form-group iphone" style="display:none;">
								...
								<div class="col-sm-7">
									<input type="text" class="form-control" id="apns_feedback_api2" value="<?php echo $service_device['apns_feedback_api2']; ?>">
								</div>								
							</div>
						</form>
