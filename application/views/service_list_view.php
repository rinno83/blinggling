...
<html lang="en"><head>
	...
	<title>xenixstudio 서비스 플랫폼 - 서비스 목록</title>
	...
	<script>
		$(document).ready(function() {
						...
						if(result != undefined && result != null)
						{
							...
							if(result.result == 1)
							{
								...
								else
								{
									...
									{
										html += '<tr>';									
										html += '<td><input type="checkbox" class="unit" item_id="'+result.db_data[i]['service_id']+'"/></td>';
										html += '<td>'+result.db_data[i]['service_id']+'</td>';
										html += '<td>'+result.db_data[i]['lang_name']+'</td>';
										html += '<td>'+result.db_data[i]['key']+'</td>';
										html += '<td>'+result.db_data[i]['secret']+'</td>';
										html += '<td><a href="/service/modify_form?service_id='+result.db_data[i]['service_id']+'">'+result.db_data[i]['name']+'</td>';
			...
			$('#write_form_btn').click(function(){
				document.location.href = '/service/write_form';
			});
		...
		<div class="row">
			<div class="col-md-12">
				...
				<table class="table table-hover" id="tableList">
					...
					?>
						<tr>
							<td><input type="checkbox" class="unit" item_id="<?php echo $row['service_id']; ?>"/></td>
							<td><?php echo $row['service_id']; ?></td>
							<td><?php echo $row['lang_name']; ?></td>
							<td><?php echo $row['key']; ?></td>
							<td><?php echo $row['secret']; ?></td>
							<td>
								<a href="/service/modify_form?service_id=<?php echo $row['service_id']; ?>">
									<?php echo $row['name']; ?>
								</a>
							</td>
