...
<html lang="en"><head>
	...
	<title>xenixstudio 서비스 플랫폼 - 약관 작성</title>
			...
			$('#write_btn').click(function(){
				...
				{	
					$.ajax({ 
						...
						url: "/terms/write",
						dataType: "json",
						data: 'service_id='+m_service_id+'&title='+encodeURIComponent(m_title)+'&content='+encodeURIComponent(m_content)+'&lang_code='+m_lang_code+'&is_show='+m_is_show+'&type='+m_type,
						error:function(data){
							...
							<div class="form-group">
								...
								<div class="col-sm-2">
									<select class="form-control" id="type">								
										<option value="service">서비스 이용 약관</option>	
										<option value="private">개인정보 보호 정책</option>	
										<option value="info">서비스 이용 안내</option>	
									</select>
								</div>
