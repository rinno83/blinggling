...
<html lang="en"><head>
	...
	<title>xenixstudio 서비스 플랫폼 - 1:1 문의 목록</title>
				...
				<table class="table table-hover" id="table_list">
					...
					?>
						<tr>
							...
							<td>
								<a href="/inquiry/modify_form?inquiry_id=<?php echo $row['inquiry_id']; ?>&current_page=<?php echo $page_info['current_page']; ?>">
									<?php echo $row['content']; ?>
								</a>
							</td>
							<td><?php echo $row['email']; ?></td>
							<td><?php echo $row['phone']; ?></td>
							<td><?php echo $row['is_answer']; ?></td>							
